...
inter = english_sub_students.intersection(french_sub_students)  #interectioning 2 sets 

print(len(inter))  #printing how many of them have both magazines sunscribed